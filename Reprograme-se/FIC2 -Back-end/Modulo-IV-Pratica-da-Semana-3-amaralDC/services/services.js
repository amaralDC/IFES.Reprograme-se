...
module.exports = class Services {
  static async TarefaCreate(req, res) {
    ...
    const options = {
      url: 'https://listatarefas.amaraldc.repl.co/tarefas/Cadastrar',
      method: 'POST',
      data: valores
    };
    axios(options);
  ...
  static async TarefaListar(req, res) {
    const options = {
      url: 'https://listatarefas.amaraldc.repl.co/tarefas',
      method: 'GET',
      data: {}
    };
  ...
  static async TarefaUpdate(req, res) {
    let valores = req.body;
    const options = {
      url: 'https://listatarefas.amaraldc.repl.co/tarefas/' + valores.id_tarefa,
      method: 'PUT',
      data: valores
    };
    axios(options);
  ...
  static async TarefaDelete(req, res) {
    ...
    const options = {
      url: 'https://listatarefas.amaraldc.repl.co/tarefas/' + id_tarefa,
      method: 'DELETE'
    };
    axios(options);
  ...
  // Services para os usuarios
  static async UsuarioCreate(req, res) {
    let valores = req.body;
    const options = {
      url: 'https://listatarefas.amaraldc.repl.co/usuarios/Cadastrar',
      method: 'POST',
      data: valores
    };
    axios(options);
  ...
  static async UsuarioListar(req, res) {
    const options = {
      url: 'https://listatarefas.amaraldc.repl.co/usuarios',
      method: 'GET',
      data: {}
    };
    axios(options).then(response => {
