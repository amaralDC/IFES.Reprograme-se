...
module.exports = class Services {
  ...
  static async UsuarioLogin(req, res) {
    ...
    const options = {
      url: 'https://apivarejo.amaraldc.repl.co/login',
      method: 'POST',
      data: valores
    };
  ...
  static async UsuarioCreate(req, res) {
    let valores = req.body;
    const options = {
      url: 'https://apivarejo.amaraldc.repl.co/add_usuario',
      method: 'POST',
      data: valores
    };
    axios(options);
  ...
  static async ProdutoCreate(req, res) {
    let valores = req.body;
    const options = {
      url: 'https://apivarejo.amaraldc.repl.co/add_produtos',
      method: 'POST',
      data: valores
    };
    axios(options);
  ...
  static async ProdutoListar(req, res) {
    const options = {
      url: 'https://apivarejo.amaraldc.repl.co/produtos',
      method: 'GET',
      data: {}
    };
